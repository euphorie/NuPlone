...
class Sitemenu(grok.View):
    ...
    def organise(self):
        ...
        is_copyable = not is_root and \
                        ICopySource.providedBy(context) and \
                        checkPermission(context, copy_or_move)
        ...
        can_paste = ICopyContainer.providedBy(context) and \
                        context.cb_dataValid()
